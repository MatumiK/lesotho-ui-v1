    ...
    function supersetReports(SUPERSET_URL) {
        ...
        if (SUPERSET_URL.substr(0, 2) !== '${') {
            reports = {
                ...
                PATIENTS: createReport('patients',
                    SUPERSET_URL + '/superset/dashboard/patients/',
                    'STOCK_STATUS_REPORT_VIEW'),
                DQA: createReport('dqa',
                    SUPERSET_URL + '/superset/dashboard/dqa/',
                    'STOCK_STATUS_REPORT_VIEW'),
                PRODUCT_LOSS: createReport('product_loss',
                    SUPERSET_URL + '/superset/dashboard/product_loss/',
                    'STOCK_STATUS_REPORT_VIEW'),
                EMERGENCY_ORDERS: createReport('emergency_orders',
                    SUPERSET_URL + '/superset/dashboard/emergency_orders/',
                    'STOCK_STATUS_REPORT_VIEW'),
                REDISTRIBUTION: createReport('redistribution',
                    SUPERSET_URL + '/superset/dashboard/redistribution/',
                    'STOCK_STATUS_REPORT_VIEW'),
